<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="RentACar._default" MaintainScrollPositionOnPostback="true" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="banner">
            <div class="banner-binlik">
             <div class="banner-sol">
                 <a href="1.html" target="cerceve"><asp:Image ID="Image1" runat="server" Height="150px" ImageUrl="~/images/logon.png" Width="250px" /></a>
                </div>  
        ...
        <div class="icerik">
            <div class="icerik-sol">
                ...
                <%--<asp:Image ID="Image3" runat="server" Height="410px" ImageUrl="~/images/ilktabela.jpg" Width="250px" />--%>
        ...
        <div style="width:1000px;height:102px; background-color:#dcddc7;margin:5px auto 0px auto">
            ...
            <div style="width:650px;height:120px;float:right"><div style="text-align:center; width: 590px; margin-left: 20px; margin-top: 18px;"><pre style="width: 588px; height: 65px;"><font face="calibri" size="4px">    Tümsan Sanayi Sitesi Tunç İş Merkezi 
     No:3/120 3.Kat Başakşehir/İSTANBUL 
            </font></pre></div></div>
